...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action=" <?= !empty($_GET['id']) ?  "../controller/Client/modifClient.php" : "../controller/Client/ajoutClient.php" ?>" method="post">
                ...
                <input value="<?= !empty($_GET['id']) ?  $client['ville'] : "" ?>" type="text" name="ville" id="ville" placeholder="Veuillez saisir la ville">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Ajout d'un lien pour supprimer un client -->
                                <a href="../controller/Client/supprimerClient.php?id=<?= $value['id'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?')"><i class='bx bx-trash'></i></a>
                                </td>
                        </tr>
                <?php
