...
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action=" <?= !empty($_GET['id']) ?  "../controller/Categorie/modifCategorie.php" : "../controller/Categorie/ajoutCategorie.php" ?>" method="post">
            ...
            <table class="mtable">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../controller/Categorie/supprimeCategorie.php?id=<?= $value['id'] ?>"onclick="return confirm('Voulez-vous vraiment supprimer cette catégorie ?');">
